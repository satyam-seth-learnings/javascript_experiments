window.onload = () => {
    ...
    function createNotification(title) {
        ...
        const img = '/Notification API/MDN Doc/img/icon-128.png';
        const text = `HEY! Your task "${title}" is now overdue.`;
        const notification = new Notification('To do list', { body: text, icon: img });

        // Add event listeners
        notification.addEventListener('show', (e) => console.log('Notification Show Event', e));
        notification.addEventListener('click', (e) => console.log('Notification Click Event', e));
        notification.addEventListener('close', (e) => console.log('Notification Close Event', e));
        notification.addEventListener('error', (e) => console.log('Notification Error Event', e));
